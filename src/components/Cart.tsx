      ...
      {productsInCart.length === 0 ? (
        ...
        <>
          ...
          <div className="flex items-center justify-between p-2 my-3">
            ...
            <h1 className="text-rose-900">{`$${Number(total).toFixed(2)}`}</h1>
          </div>
          ...
          <div className="flex items-center justify-center p-2 bg-red text-white font-medium cursor-pointer rounded-2xl w-full my-3">
